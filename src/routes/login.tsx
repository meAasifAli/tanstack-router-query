...
function Login() {
  ...
  return (
    <section className="flex flex-col md:flex-row h-screen items-center">
      ...
      <div className="bg-white w-full md:max-w-md lg:max-w-full md:mx-auto lg:mx-0 md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12
        ...
        <div className="w-full h-100">
          ...
          <button type="button" className="w-full block bg-white hover:bg-gray-100 focus:bg-gray-100 text-gray-900 font-semibold rounded-lg px-4 py-3 border border-gray-300">
            <div className="flex items-center justify-center">
              <img className='h-6 w-6 object-contain' src="https://th.bing.com/th/id/OIP.flV_HAhkgpxUwwDRW-5p9AHaHa?w=170&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7" alt="" />
              <span className="ml-4">
                Log in
                with
                Google</span>
